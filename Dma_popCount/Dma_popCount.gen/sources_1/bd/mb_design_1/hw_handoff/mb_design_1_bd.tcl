...
################################################################
# This is a generated script based on design: mb_design_1
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: HamDistPop_0, and set properties
  set HamDistPop_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:HamDistPop:1.0 HamDistPop_0 ]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins HamDistPop_0/S00_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M09_AXI [get_bd_intf_pins HamDistPop_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M09_AXI]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs HamDistPop_0/S00_AXI/S00_AXI_reg] -force
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs HamDistPop_0/S00_AXI/S00_AXI_reg] -force
