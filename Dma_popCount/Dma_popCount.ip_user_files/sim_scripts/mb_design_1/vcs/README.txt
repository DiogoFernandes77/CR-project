...
#
# Generated by export_simulation on Thu Jun 17 18:20:54 +0100 2021
#
################################################################################
...
'-reset_run' switch to the './mb_design_1.sh' script.

./mb_design_1.sh -reset_run
...
./mb_design_1.sh -noclean_files

For more information on the script, please type './mb_design_1.sh -help'.
